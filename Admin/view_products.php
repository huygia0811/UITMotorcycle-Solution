                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr style='text-align:center'>
                                                    ...
                                                    <td style='width:100px;'><img src='../<?php echo $url_img ?>' style='width: 100%; height: 100%; object-fit: contain;'>
                                                    ...
                                                    <td>
                                                        <div class="Action">
                                                            <a href='product_edit.php?id=<?php echo $masp ?>' class='btn btn-sm btn-primary'>Edit</a>
                                                            <a href='product_delete.php?id=<?php echo $row['MASP']; ?>' class='btn btn-sm btn-danger' onclick="return confirm('Bạn có muốn xóa sản phẩm này?');">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php
