            ...
            <div class="fixed_nav">
                ...
                <div class="menu_col2">
                    <div class="account" id="submenu_account">
                        <a href="#" class="account_taikhoan"><img src="asset/Picture/user.png" height="15px" /> Tài
                            khoản</a>

                        <a href="#" class="account_lsmua"><img src="asset/Picture/lsmh.png" height="15px" /> Lịch sử mua
                            hàng</a>
                        <!--Header Cart -->
                        <div class="header_cart">
                            <a href="shopping_cart.php" class="account_giohang"><img src="asset/Picture/cart.png"
                                    height="15px" /> Giỏ
                                hàng</a>
                            <!-- No cart class name: header_cart-list--no-cart -->
                            <div class="header_cart-list">
                                <img src="./asset/Header_cart/empty-cart.webp" alt="" class="header_cart-no-cart-img" />

                                <h4 class="header_cart-heading">Sản phẩm đã thêm</h4>
                                <ul class="header_cart-list-item">
                                    <!-- Cart item -->
                                    <li class="header_cart-item">
                                        <img src="./asset/Picture/sh_1_test.jpg" alt="" class="header_cart-img" />
                                        <div class="header_cart-item-info">
                                            <div class="header_cart-item-head">
                                                <h5 class="header_cart-item-name">Xe máy yamaha</h5>
                                            ...
                                            <div class="header_cart-item-body">
                                                <span class="header_cart-item-description">Màu: Đỏ Đen</span>
                                ...
                                <a href="shopping_cart.php" class="header_cart-view-cart-link"><button
                    ...
                    <div class="search">
                        <div class="srch_input">
                            <input type="search" placeholder="&#xF002;   Nhập từ khóa tìm kiếm" style="
                  padding: 10px;
                  text-align: center;
                ...
                " />
                        ...
                        <div class="srch_button">
                            <button type="button">
                                <img src="asset/Picture/filter-icon@2x.png" />
                            </button>
                        </div>
                    </div>
                </div>
