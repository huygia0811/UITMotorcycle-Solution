...
(15, 1, 'Winner X', '150cc', 'Đỏ Đen', '2022', 46160000, 3, 'Asset/DB-Picture/XPKL_4.png',1, 112),
(16, 1, 'Winner X', '150cc', 'Đỏ Đen Xanh', '2022', 46160000, 3, 'Asset/DB-Picture/XPKL_5.png',1, 114),
...
(30, 1, 'Super Cub C126', '125cc', 'Xanh, trắng', '2021', 85801091, 1, 'Asset/DB-Picture/xs18.png',1, 45),
(31, 1, 'Super Cub C127', '125cc', 'Xanh, trắng', '2021', 85801091, 1, 'Asset/DB-Picture/xs19.png',1, 87),
(32, 1, 'Wave Alpha 110cc phiên bản 2024', '110cc', 'Trắng, bạc', '2022', 17859273, 1, 'Asset/DB-Picture/xs02.png',1, 66),
...
(35, 1, 'Wave RSX FI 111', '110cc', 'Đỏ, đen', '2020', 24633818, 1, 'Asset/DB-Picture/xs22.png',1, 120),
(36, 1, 'Wave RSX FI 112', '110cc', 'Xanh, đen', '2020', 24633818, 1, 'Asset/DB-Picture/xs23.png',1, 100),
...
(43, 1, 'Wave Alpha 110cc phiên bản 2025', '110cc', 'Xanh, bạc', '2022', 17859273, 1, 'Asset/DB-Picture/xs03.png',1, 87),
...
(51, 4, 'Star SR 170 (ABS)', '175cc', 'Đen, đỏ', '2019', 52400000, 1, 'Asset/DB-Picture/xs37.png',1, 124),
(52, 4, 'Star SR 170 (ABS)', '175cc', 'Đen, xanh', '2019', 52400000, 1, 'Asset/DB-Picture/xs38.png',1, 97),
(53, 4, 'Elegant 110', '110cc', 'Xanh, đen', '2021', 16700000, 1, 'Asset/DB-Picture/xs39.png',1, 78),
(54, 1, 'Wave Alpha 110cc phiên bản 2026', '110cc', 'Đen mờ', '2022', 18448364, 1, 'Asset/DB-Picture/xs04.png',1, 54),
(55, 4, 'Elegant 111', '110cc', 'Đỏ, đen', '2021', 16700000, 1, 'Asset/DB-Picture/xs40.png',1, 75),
(56, 4, 'Elegant 112', '110cc', 'Trắng, đen', '2021', 16700000, 1, 'Asset/DB-Picture/xs41.png',1, 45),
(57, 4, 'Angela 50', '50cc', 'Xám, đen', '2021', 16800000, 1, 'Asset/DB-Picture/xs42.png',1, 78),
(58, 4, 'Angela 51', '50cc', 'Trắng, đỏ', '2021', 16800000, 1, 'Asset/DB-Picture/xs43.png',1, 87),
(59, 4, 'Angela 52', '50cc', 'Xanh, trắng', '2021', 16800000, 1, 'Asset/DB-Picture/xs44.png',1, 100),
(60, 4, 'Galaxy 49', '50cc', 'Đen, cam (sơn mờ)', '2020', 17300000, 1, 'Asset/DB-Picture/xs45.png',1, 145),
(61, 4, 'Galaxy 50', '50cc', 'Đỏ, đen', '2020', 16800000, 1, 'Asset/DB-Picture/xs46.png',1, 156),
(62, 4, 'Elegant 50', '50cc', 'Đỏ, đen', '2020', 16000000, 1, 'Asset/DB-Picture/xs47.png',1, 153),
(63, 4, 'Elegant 51', '50cc', 'Xanh, đen', '2020', 16000000, 1, 'Asset/DB-Picture/xs48.png',1, 160),
(64, 1, 'Blade 110', '110cc', 'Đen, xanh, xám', '2020', 21295637, 1, 'Asset/DB-Picture/xs05.png',1, 187),
(65, 1, 'Blade 111', '110cc', 'Đen, đỏ, xám', '2020', 21295637, 1, 'Asset/DB-Picture/xs06.png',1, 198),
(66, 1, 'Blade 112', '110cc', 'Đen, xám', '2020', 21295637, 1, 'Asset/DB-Picture/xs07.png',1, 98),
(67, 1, 'Blade 113', '110cc', 'Đỏ, đen', '2020', 18841091, 1, 'Asset/DB-Picture/xs08.png',1, 201),
(68, 1, 'Blade 114', '110cc', 'Đen', '2020', 19822909, 1, 'Asset/DB-Picture/xs09.png',1, 142),
(69, 1, 'Air Blade 125 Phiên bản Đặc biệt', '125cccc', 'Đen Vàng', '2022', 42502909, 2, 'Asset/DB-Picture/XTG_1.png',1, 145),
(70, 1, 'Lead 125cc Cao cấp', '125cccc', 'Xanh', '2022', 41226545, 2, 'Asset/DB-Picture/XTG_10.png',1, 156),
(71, 1, 'Lead 125cc Cao cấp', '125cccc', 'Xám', '2022', 41226545, 2, 'Asset/DB-Picture/XTG_11.png',1, 142),
(72, 1, 'Lead 125cc Đặc biệt', '125cccc', 'Đen', '2022', 42306454, 2, 'Asset/DB-Picture/XTG_12.png',1, 125),
(73, 1, 'Lead 125cc Đặc biệt', '125cccc', 'Bạc', '2022', 42306454, 2, 'Asset/DB-Picture/XTG_13.png',1, 142),
(74, 1, 'Lead 125cc Tiêu chuẩn', '125cccc', 'Trắng', '2022', 39066545, 2, 'Asset/DB-Picture/XTG_14.png',1, 89),
(75, 1, 'Lead 125cc Tiêu chuẩn', '125cccc', 'Đỏ', '2022', 39066545, 2, 'Asset/DB-Picture/XTG_15.png',1, 78),
(76, 3, 'FreeGo Phiên bản Tiêu chuẩn màu mới', '125cccc', 'Đỏ Đen', '2022', 29900000, 2, 'Asset/DB-Picture/XTG_16.png',1, 145),
(77, 3, 'FreeGo Phiên bản Tiêu chuẩn màu mới', '125cccc', 'Trắng Đen', '2022', 29900000, 2, 'Asset/DB-Picture/XTG_17.png',1, 187),
(78, 3, 'FreeGo Phiên bản Tiêu chuẩn màu mới', '125cccc', 'Đen', '2022', 29900000, 2, 'Asset/DB-Picture/XTG_18.png',1, 87),
(79, 3, 'FreeGo S Phiên bản Đặc biệt màu mới', '125cccc', 'Đỏ Đen', '2022', 33800000, 2, 'Asset/DB-Picture/XTG_19.png',1, 89),
(80, 1, 'Air Blade 125 Phiên bản Tiêu chuẩn', '125cccc', 'Xanh Đen', '2022', 41324727, 2, 'Asset/DB-Picture/XTG_2.png',1, 85),
(81, 3, 'FreeGo S Phiên bản Đặc biệt màu mới', '125cccc', 'Xám Đen', '2022', 33800000, 2, 'Asset/DB-Picture/XTG_20.png',1, 142),
(82, 3, 'FreeGo S Phiên bản Đặc biệt màu mới', '125cccc', 'Xanh lá Đen', '2022', 33800000, 2, 'Asset/DB-Picture/XTG_21.png',1, 132),
(83, 3, 'FreeGo S Phiên bản Đặc biệt màu mới', '125cccc', 'Xanh Đen', '2022', 33800000, 2, 'Asset/DB-Picture/XTG_22.png',1, 54),
(84, 3, 'Latte Phiên bản Tiêu chuẩn', '125cccc', 'Đỏ Đen', '2022', 37800000, 2, 'Asset/DB-Picture/XTG_23.png',1, 96),
(85, 3, 'Latte Phiên bản Tiêu chuẩn', '125cccc', 'Trắng Đen', '2022', 37800000, 2, 'Asset/DB-Picture/XTG_24.png',1, 47),
(86, 3, 'Latte Phiên bản Tiêu chuẩn', '125cccc', 'Đen', '2022', 37800000, 2, 'Asset/DB-Picture/XTG_25.png',1, 100),
(87, 3, 'Latte Phiên bản Giới hạn', '125cccc', 'Bạc', '2022', 38300000, 2, 'Asset/DB-Picture/XTG_26.png',1, 123),
(88, 3, 'Grande Blue Core Hybrid Phiên bản Tiêu chuẩn', '125cccc', 'Đỏ Đen', '2022', 45200000, 2, 'Asset/DB-Picture/XTG_27.png',1, 142),
(89, 3, 'Grande Blue Core Hybrid Phiên bản Tiêu chuẩn', '125cccc', 'Trắng Đen', '2022', 45200000, 2, 'Asset/DB-Picture/XTG_28.png',1, 125),
(90, 3, 'Grande Blue Core Hybrid Phiên bản Tiêu chuẩn', '125cccc', 'Đen', '2022', 45200000, 2, 'Asset/DB-Picture/XTG_29.png',1, 126),
(91, 1, 'Air Blade 125 Phiên bản Tiêu chuẩn', '125cccc', 'Đỏ Đen', '2022', 41324727, 2, 'Asset/DB-Picture/XTG_3.png',1, 120),
(92, 3, 'Grande Phiên bản Giới hạn hoàn toàn mới', '125cccc', 'Hồng ánh đồng Đen', '2022', 51000000, 2, 'Asset/DB-Picture/XTG_30.png',1, 102),
(93, 3, 'Grande Phiên bản Giới hạn hoàn toàn mới', '125cccc', 'Bạc Đen', '2022', 51000000, 2, 'Asset/DB-Picture/XTG_31.png',1, 103),
(94, 3, 'Grande Phiên bản Giới hạn hoàn toàn mới', '125cccc', 'Xám Đen', '2022', 51000000, 2, 'Asset/DB-Picture/XTG_32.png',1, 152),
(95, 3, 'Grande Phiên bản Giới hạn hoàn toàn mới', '125cccc', 'Xanh Đen', '2022', 51000000, 2, 'Asset/DB-Picture/XTG_33.png',1, 142),
(96, 2, 'Impulse 125 FI', '125cccc', 'Đen Mờ', '2019', 31408000, 2, 'Asset/DB-Picture/XTG_34.png',1, 120),
(97, 2, 'Impulse 125 FI', '125cccc', 'Đen Mờ Xám', '2019', 31408000, 2, 'Asset/DB-Picture/XTG_35.png',1, 90),
(98, 2, 'Impulse 125 FI', '125cccc', 'Xanh Đỏ', '2019', 31408000, 2, 'Asset/DB-Picture/XTG_36.png',1, 80),
(99, 2, 'Impulse 125 FI', '125cccc', 'Trắng Nâu Bạc', '2019', 31408000, 2, 'Asset/DB-Picture/XTG_37.png',1, 123),
(100, 2, 'Burgman Street', '125cccc', 'Xám Mờ Vàng Đồng', '2022', 48600000, 2, 'Asset/DB-Picture/XTG_38.png',1, 70),
(101, 2, 'Burgman Street', '125cccc', 'Đen Vàng Đồng', '2022', 48600000, 2, 'Asset/DB-Picture/XTG_39.png',1, 75),
(102, 1, 'Air Blade 160 Phiên bản Đặc biệt', '160cccc', 'Xanh Xám Đen', '2022', 57190000, 2, 'Asset/DB-Picture/XTG_4.png',1, 75),
(103, 2, 'Burgman Street', '125cccc', 'Trắng Vàng Đồng', '2022', 48600000, 2, 'Asset/DB-Picture/XTG_40.png',1, 152),
(104, 1, 'Air Blade 160 Phiên bản Tiêu chuẩn', '160cccc', 'Đỏ Xám', '2022', 55990000, 2, 'Asset/DB-Picture/XTG_5.png',1, 140),
(105, 1, 'Air Blade 160 Phiên bản Tiêu chuẩn', '160cccc', 'Đen Xám', '2022', 55990000, 2, 'Asset/DB-Picture/XTG_6.png',1, 100),
(106, 1, 'Air Blade 160 Phiên bản Tiêu chuẩn', '160cccc', 'Xanh Xám', '2022', 55990000, 2, 'Asset/DB-Picture/XTG_7.png',1, 80),
(107, 1, 'Lead 125cc Cao cấp', '125cccc', 'Trắng', '2022', 41226545, 2, 'Asset/DB-Picture/XTG_8.png',1, 88),
(108, 1, 'Lead 125cc Cao cấp', '125cccc', 'Đỏ', '2022', 41226545, 2, 'Asset/DB-Picture/XTG_9.png',1, 94);
